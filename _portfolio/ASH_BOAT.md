...
<div class="portfolio__image-container">
  <div class="portfolio__still-grid" style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:12px;">
    ...
    <img src='/images/ash_boat_still_frames/Photo%204%2014-04-01-Ann1772077788094.jpg' alt='Ash Boat still frame 4' style="width:100%; height:auto; display:block;">
    <img src='/images/ash_boat_still_frames/Photo%205%2008-11.2-1772366700982.jpg' alt='Ash Boat still frame 5' style="width:100%; height:auto; display:block;">
    <img src='/images/ash_boat_still_frames/Photo%206%2015-26.2-1772822594282.jpg' alt='Ash Boat still frame 6' style="width:100%; height:auto; display:block;">
  </div>
</div>

• Position: Technical Director <br>

• Running Time: 20 min <br> <br>
...
As their fragile relationship unravels, Helen begins to understand that memory, companionship, and farewell cannot be fabricated. An also discovers the cruel truth behind Helen’s promised “promotion”: rather than advancement, it means disposal and erasure. On the final day of mourning, Helen chooses to sacrifice herself, creating the vision of an “Ash Boat” to help An face loss and let go.
